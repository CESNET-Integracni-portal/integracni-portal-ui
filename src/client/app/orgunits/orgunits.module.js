(function () {
    ...
    // CONTROLLER
    orgmod.controller('orgunitsCtrl', /* @ngInject */ function ($scope, unitService, userService) {
        // Ready for API v0.2
    ...
    // DIRECTIVE
    orgmod.directive("setOrgunits", /* @ngInject */ function () {
        return {
            restrict: 'E',
            templateUrl: "app/orgunits/set-org-units.html",
